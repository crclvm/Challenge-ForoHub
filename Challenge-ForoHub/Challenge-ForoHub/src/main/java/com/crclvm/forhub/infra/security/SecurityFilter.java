package com.marcode.forhub.infra.security;

import com.marcode.forhub.domain.usuario.UsuarioRepository;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authHeader != null) {
            ...
            var nombreUsuario = tokenService.getSubject(token); // extrae username, y a subject es igual a nombreUsuario
